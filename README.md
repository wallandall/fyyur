...
```
git clone git@github.com:wallandall/fyyur.git
cd fyuur
```
...
5. In the project folder create a file called .env and add a variable called DEV_DATABASE_URI and PROD_DATABASE_URI . This file will be used for the database connection and is added to the .gitignore so will not be deployed to source control:
